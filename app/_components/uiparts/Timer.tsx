...
const Timer = (props: Props) => {
    return (
        ...
        >
            ...
            <div className="m-1" onClick={props.onTapPauseButton} onKeyUp={props.onTapPauseButton}>
                <HiOutlinePlayPause/>
            </div>
            <div className="m-1" onClick={props.onTapResetButton} onKeyUp={props.onTapResetButton}>
                <GrPowerReset/>
            </div>
        </div>
    );
